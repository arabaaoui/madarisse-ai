/**
 * API Route — Confirme une action HITL proposée par l'agent.
 * Appelle /action/confirm sur le service agent avec le JWT utilisateur.
 */
...
export async function POST(request: NextRequest) {
  ...
  const res = await fetch(`${agentServiceUrl}/action/confirm`, {
    method: 'POST',
    headers: {
